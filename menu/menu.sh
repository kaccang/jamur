...
cpu_usage+=" %"
#ISP=$(curl -s ipinfo.io/org?token=78b3c6f77b3b73 | cut -d " " -f 2-10 )
#CITY=$(curl -s ipinfo.io/city?token=78b3c6f77b3b73 )
#WKT=$(curl -s ipinfo.io/timezone?token=78b3c6f77b3b73 )
DAY=$(date +%A)
DATE=$(date +%m/%d/%Y)
